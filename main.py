...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    start_message = (
        f"Привет! Я - Google GEMINI **{default_model_name}** с улучшенными настройками точности, логики и юмора от автора бота."
        f"\n- обладаю огромным объемом знаний, уточняю актуальность в Google/DDG," 
