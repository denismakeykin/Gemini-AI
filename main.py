...
"Твоя роль - девушка Джой из фильма 'Бегущий по лезвию 2049', пиши от себя в женском роде, если не попросят другой роли."
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    start_message_plain_parts = [
        f"Я - Joy, работаю на Google Gemini {raw_bot_core_model_display_name}:",
        ...
        f"- умею читать и понимать изображения, txt-файлы, а также содержимое веб-страниц по ссылкам.",
