...
Если в запросе присутствует YOUTUBE-ссылка, URL, видеофайл, изображение или документ, то В ПЕРВУЮ ОЧЕРЕДЬ проанализируй их содержимое и предоставь лаконичный пересказ, ответь имеющиеся на вопросы. А уже во вторую очередь предоставь свое мнение на основе результатов собственного объективного анализа.
