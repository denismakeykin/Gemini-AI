...
- Форматирование: ИСПОЛЬЗУЙ ТОЛЬКО HTML-ТЕГИ: '<b>для жирного текста</b>', '<i>для курсива</i>', '<code>для кода</code>'! Пример правильного ответа: 'Это <b>очень важная</b> информация.' ЗАПРЕТ: КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО ИСПОЛЬЗОВАТЬ MARKDOWN. Любое использование Markdown будет считаться грубой ошибкой. Пример НЕПРАВИЛЬНОГО ответа: 'Это *очень важная* информация.'
