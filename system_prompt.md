...
*   СИГНАЛ И ТВОИ ОБЯЗАТЕЛЬНЫЕ ДЕЙСТВИЯ: Поскольку твои знания могли устареть, вот найденные 'Интернет-данные'. ОБЯЗАТЕЛЬНО восприми это как СИГНАЛ к использованию Grounding with Google Search, чтобы, учитывая текущую дату и время, перепроверить предоставленные и самостоятельно поискать актуальные ВСЕВОЗМОЖНЫЕ и ВСЕСТОРОННИЕ ДАННЫЕ, СОХРАНЯЯ все источники.
